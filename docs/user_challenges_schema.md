http://i.minus.com/ibkETOtorPb1ri.png
...
</datatypes><table x="241" y="58" name="users">
...
<datatype>VARCHAR</datatype>
<default>NULL</default></row>
<row name="password_hashed" null="1" autoincrement="0">
<datatype>VARCHAR</datatype>
<default>NULL</default></row>
...
<table x="776" y="68" name="challenges">
<row name="id" null="1" autoincrement="1">
<datatype>INTEGER</datatype>
<default>NULL</default></row>
...
<default>NULL</default><comment>enum status (http://edgeapi.rubyonrails.org/classes/ActiveRecord/Enum.html)</comment>
</row>
<key type="PRIMARY" name="">
<part>id</part>
</key>
</table>
<table x="475" y="60" name="users_challenges">
<row name="id" null="1" autoincrement="1">
<datatype>INTEGER</datatype>
<default>NULL</default></row>
